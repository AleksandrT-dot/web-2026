        ...
        <div class="net-feed__post">
            <form class="net-feed__posting-user">
                <div class="net-feed__user">
                    <img class="net-feed__avatar" src="<?= $post['author_avatar'] ?>" alt="unknown avatar">
                    <p class="net-feed__name"><?= $post['author_name'] ?></p>
                </div>
                <?php if (isset($post['has_edit']) && $post['has_edit']): ?>
                    <img class="net-feed__item-edit" src="item_edit.png" alt="edit">
                <?php endif; ?>
            </form>
            
            <form class="net-feed__main-photo">
                <img class="net-feed__posted-photo" src="<?= $post['photo'] ?>" alt="photo">
                <?php if (isset($post['has_multiple_photos']) && $post['has_multiple_photos']): ?>
                    <div class="net-feed__navigation-photo">
                        <img class="net-feed__item net-feed__item_active" src="slider_active.png" alt="next">
                        <img class="net-feed__item net-feed__item_unactive" src="slider_unactive.png" alt="prev">
                        <img class="net-feed__item-num-page" src="item_num_page.png" alt="first">
                    </div>
                <?php endif; ?>
            </form>
